...
">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  ...
                  <span class="fw-semi-bold text-900">Projects</span>
                  <script>
            ...
            <h6 class="text-muted font-weight-normal">Projects List</h6>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="text-muted font-weight-normal">Member List</h6>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  <h2 class="mb-0 me-2" id="studentCount">Loading...</h2>
                  <span class="fw-semi-bold text-900">Students</span>
                </div>
              </div>
              <div class="col-3">
                <div class="icon icon-box-success">
            ...
            <h6 class="text-muted font-weight-normal">Student List</h6>
          </div>
        </div>
      </div>
      ...
      <script>
        $(document).ready(function () {
          // Make an AJAX GET request to fetch student count
          $.ajax({
            url: '/getstudentcount',
            type: 'GET',
            dataType: 'json',
            success: function (data) {
              // Update the DOM with the fetched student count
      ...
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="text-muted font-weight-normal">Total Developer</h6>
          </div>
        </div>
      </div>
    </div>
